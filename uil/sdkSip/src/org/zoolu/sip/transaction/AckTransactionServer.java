...
public class AckTransactionServer extends Transaction {
	...
	public void respond() throws Exception {
		Log.info("AckTransactionServer", "respond connection_id:" + connection_id);
	...
	public void onTimeout(Timer to) {
		try {
			if (to.equals(retransmission_to) && statusIs(STATE_PROCEEDING)) {
			    Log.error("AckTransactionServer.onTimeout", "retransmission_to");
			...
			if (to.equals(transaction_to) && statusIs(STATE_PROCEEDING)) {
			    Log.error("AckTransactionServer.onTimeout", "transaction_to");
		    ...
		    Log.exception("AckTransactionServer.onTimeout", e);
		}
	}
