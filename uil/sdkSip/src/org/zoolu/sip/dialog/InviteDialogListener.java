...
public interface InviteDialogListener {
	...
	public void onDlgInvite(InviteDialog dialog, NameAddress callee,
			NameAddress caller, String body, Message msg) throws Exception;

	/** When an incoming Re-INVITE is received 
	 * @throws Exception */
	public void onDlgReInvite(InviteDialog dialog, String body, Message msg) throws Exception;
	...
	public void onDlgInviteRedirectResponse(InviteDialog dialog, int code,
			String reason, MultipleHeader contacts, Message msg) throws Exception;
