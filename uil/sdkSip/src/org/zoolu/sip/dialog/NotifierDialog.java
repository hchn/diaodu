																				 ...
																				 */
{
	...
	public void listen() {
	    Log.info("NotifierDialog", "listen");
		if (!statusIs(D_INIT)) {
		    Log.info("NotifierDialog", "first subscription already received");
			return;
		}
		// else
	 ...
	 * @throws Exception */
	public void accept(int expires, String contact) throws Exception {
	    Log.info("NotifierDialog", "accept");
	...
	public void refuse() throws Exception {
	    Log.info("NotifierDialog", "refuse");
	...
	public void respond(int code, String reason, int expires, String contact,
			String content_type, String body) throws Exception {
	    Log.info("NotifierDialog", "inside respond(" + code + "," + reason + ")");
	...
	public void respond(Message resp) throws Exception {
	    Log.info("NotifierDialog", "respond");
	...
	/** Activates the subscription (subscription goes into 'active' state). 
	 * @throws Exception */
	public void activate(int expires) throws Exception {
	...
	/** Makes the subscription pending (subscription goes into 'pending' state). 
	 * @throws Exception */
	public void pending(int expires) throws Exception {
	...
	/** Sends a NOTIFY. 
	 * @throws Exception */
	public void notify(Message req) throws Exception {
	...
	public void onTransProvisionalResponse(TransactionClient tc, Message resp) {
	    Log.info("NotifierDialog", "onTransProvisionalResponse");
		// do nothing.
	}
	...
	public void onTransSuccessResponse(TransactionClient tc, Message resp) {
	    Log.info("NotifierDialog", "onTransSuccessResponse");
	...
	public void onTransFailureResponse(TransactionClient tc, Message resp) {
	    Log.info("NotifierDialog", "onTransFailureResponse");
		StatusLine status_line = resp.getStatusLine();
		if (listener != null)
	...
	public void onTransTimeout(TransactionClient tc) {
	    Log.error("NotifierDialog", "onTransTimeout");
	...
	public void onReceivedMessage(SipProvider provider, Message msg) {
		Log.info("NotifierDialog", "onReceivedMessage");
		if (statusIs(D_TERMINATED)) {
		    Log.info("NotifierDialog", "subscription already terminated: message discarded");
			return;
		}
		// else
		if (msg.isRequest() && msg.isSubscribe()) {
		    ...
		    Log.error("NotifierDialog", "message is not a SUBSCRIBE: message discarded");
		}
	}
