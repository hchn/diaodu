...
public class SipHeaders extends BaseSipHeaders {
    ...
    /** String "User-to-User" */
    public static final String User_To_User = "User-to-User";
    

    public static final String CALL_ID_TRANSFER = "CallID-Transfer";

    /** String "Resource-Priority" */
    public static final String Resource_Priority = "Resource-Priority";
    /** String "Terminate-Priority" */
    public static final String Terminate_Priority = "Terminate-Priority";    
