...
public abstract class BaseSipHeaders {
	...
	/** String "Extra-Methord" */
    public static final String Extra_Methord = "Extra-Methord";
    /** String "Reason" */
    public static final String Reason = "Reason";
    /** String "Refresh-From" */
    public static final String Refresh_From = "Refresh-From";
    /** String "Call-ID" */
    public static final String P_JXACTIVE_NETWORK_ID = "P-JXActive-Network-ID";
    /** String "call-type" */
    public static final String CALL_TYPE = "call-type";

	/** Whether <i>s1</i> and <i>s2</i> are case-insensitive-equal. */
