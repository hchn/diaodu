...
public class KeepAliveSip extends KeepAliveUdp
{
    ...
    public KeepAliveSip(SipProvider sip_provider, long delta_time, LineAdapter lineAdapter)
    {
        super(null, delta_time, lineAdapter);
        init(sip_provider, null);
        start();
    }

    /** Creates a new SIP KeepAliveSip daemon */
    public KeepAliveSip(SipProvider sip_provider, Message message, long delta_time, LineAdapter lineAdapter)
    {
        super(null, delta_time, lineAdapter);
    ...
    private void init(SipProvider sip_provider, Message message)
    {
        ...
        if (message == null)
        {
            NameAddress target = new NameAddress(sip_provider.getOrigAddr());
            message = MessageFactory.createRequest(sip_provider, SipMethods.OPTIONS, target, target, null);
        }
    ...
    public String toString()
    {
        ...
        {
            str = "sip:" + sip_provider.getViaAddress() + ":" + sip_provider.getPort();
        }
