...
public interface Codec {
	...
	int decode(byte encoded[], short lin[], int size,int offset);
	 ...
	 *
	 * @param alaw The buffer to place the encoded stream
	 *
	 * @param frames the size of the linear pcm stream (in words)
	 *
