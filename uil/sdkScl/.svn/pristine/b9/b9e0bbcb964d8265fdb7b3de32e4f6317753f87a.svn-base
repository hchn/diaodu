...
import com.jiaxun.sdk.scl.util.net.impl.PlainDatagramSocketImpl;
...
public class SipdroidSocket extends DatagramSocket {
	...
	public SipdroidSocket(int port, InetAddress address) throws SocketException, UnknownHostException {
		super(!loaded?port:0, address);
		if (loaded) {
			impl = new PlainDatagramSocketImpl();
			impl.create();
			impl.bind(port,InetAddress.getByName("0"));
...
//			} catch (Throwable e) {
//                e.printStackTrace();
//                Log.e("POXDROID-POC", "Can't load the OSNetworkSystem.");
//			}
//	}
}
