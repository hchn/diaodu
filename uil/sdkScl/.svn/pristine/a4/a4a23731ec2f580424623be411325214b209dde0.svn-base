...
public class WavWriter
{
	...
	public WavWriter(String filename,int sample_rate)
	{
		...
		{
			Log.error("CallRecorder", "Error creating output file.");
			raf = null;
		}
	}
	...
	synchronized void writeLeft(short[] buffer, int offs, int len)
	{
		...
		{
			Log.error("CallRecorder", "Error writing to output file.");
		}
	}
	...
	synchronized void close()
	{
		...
		{
			Log.error("CallRecorder", "Error writing final data to output file.");
		}
	}
