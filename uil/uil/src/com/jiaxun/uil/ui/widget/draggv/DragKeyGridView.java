 ...
 * @Date 2015-6-10
 */
public class DragKeyGridView extends GridView
{
    /**
    ...
    public DragKeyGridView(Context context) {
        this(context, null);
    }
    
    public DragKeyGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragKeyGridView(Context context, AttributeSet attrs, int defStyle) {
...
//                animateReorder(position, getLastVisiblePosition() + 1 );
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            if(mDragAdapter != null && !mDragAdapter.isCanMove(mDragPosition))
            {
