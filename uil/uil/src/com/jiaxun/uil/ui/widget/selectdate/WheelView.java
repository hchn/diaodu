...
public class WheelView extends View {
	...
	/** Current value & label text color 当前选中字体颜色*/
	private static final int VALUE_TEXT_COLOR = 0xF0000000;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = Color.GRAY;

	/** Top and bottom shadows colors 顶部和底部的颜色*/
	private static final int[] SHADOWS_COLORS = new int[] { Color.TRANSPARENT,
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.middle_bg);
		}
