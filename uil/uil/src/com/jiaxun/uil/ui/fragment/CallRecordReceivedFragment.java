...
public class CallRecordReceivedFragment extends BaseCallRecordFragment
{
    private final String TAG = CallRecordReceivedFragment.class.getName();

    public CallRecordReceivedFragment()
    {
        super();
    }
